...
const DigitalGift = () => {
  ...
  return (
    <section id="digital-gift" className="py-24 px-4 bg-gradient-to-b from-rose-50 via-pink-50 to-rose-100 relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-5xl relative z-10">
        <div className="text-center mb-16" data-aos="fade-up">
          <h2 className="text-5xl md:text-6xl font-bold mb-6 text-rose-700 font-elegant gradient-text animate-shimmer">
            Amplop Digital
          </h2>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16" data-aos="fade-up" data-aos-delay="100">
          {accounts.map((account) => {
            ...
            return (
              <div 
                key={account.id} 
                className="bg-white/70 backdrop-blur-lg rounded-2xl shadow-lg border border-pink-200 p-6 transition-all duration-300 hover:shadow-xl hover:-translate-y-1"
              >
                ...
                <div className="text-center bg-rose-50/80 rounded-lg p-4 my-4 border border-rose-200">
                  <p className="text-rose-600 text-sm">a/n {account.name}</p>
                  <p className="text-2xl font-bold text-rose-700 tracking-wider my-1">{account.number}</p>
                </div>
                <Button
        ...
        <div className="text-center" data-aos="fade-up" data-aos-delay="200">
          <div className="bg-white/80 backdrop-blur-md rounded-2xl p-6 md:p-8 shadow-lg border border-pink-200 max-w-2xl mx-auto transition-all duration-500 hover:shadow-xl">
            <div className="flex flex-col items-center text-center">
              <div className="mb-4">
                <div className="w-16 h-16 bg-gradient-to-br from-pink-400 via-rose-500 to-pink-500 rounded-full flex items-center justify-center shadow-md border-2 border-white/80 animate-heart-beat">
                  <Heart className="w-8 h-8 text-white" />
                </div>
              </div>
              <h3 className="text-3xl md:text-4xl font-bold mb-3 text-rose-700 font-elegant gradient-text">
                Dengan Penuh Syukur
              </h3>
              <div className="w-20 h-0.5 bg-gradient-to-r from-rose-300 to-pink-300 rounded-full my-2"></div>
              <p className="text-rose-600 text-base leading-relaxed max-w-prose mx-auto">
